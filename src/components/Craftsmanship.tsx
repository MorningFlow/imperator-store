...
export default function Craftsmanship() {
  return (
    <section className="bg-obsidian-light py-24 px-6 relative border-t border-charcoal">
      {/* Background Image */}
      ...
      <div className="relative z-10 pt-24 max-w-lg mx-auto">
        ...
        <div className="space-y-8">
          ...
          <div className="flex items-start gap-6 border-b border-charcoal/50 pb-6 border-l-2 border-l-transparent hover:border-l-gold pl-4 transition-all duration-300">
            ...
            <div>
              ...
              <p className="text-offwhite/50 text-xs leading-relaxed">Choose from our curated selection of exotic, battle-ready hardwoods sourced globally.</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-6 border-l-2 border-l-transparent hover:border-l-gold pl-4 transition-all duration-300">
